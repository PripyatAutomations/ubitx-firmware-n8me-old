...
const unsigned BUTTON_BORDER_COLOR = ILI9341_DARKGREEN;
const unsigned BUTTON_BUTTON_BG_COLOR = ILI9341_BLACK;
const unsigned BUTTON_TEXT_COLOR = ILI9341_DARKGREEN;
const unsigned HIGH_BUTTON_BG_COLOR = ILI9341_DARKGREEN;
...
const unsigned KEYPAD_COLOR = ILI9341_RED;
const unsigned MINI_LABEL_COLOR = ILI9341_RED;

const unsigned HB_COLOR = ILI9341_GREENYELLOW;
const unsigned CAT_HB_COLOR = ILI9341_DARKCYAN;

const unsigned BANNER_BG = ILI9341_BLACK;
const unsigned BANNER_FG = ILI9341_DARKCYAN;
